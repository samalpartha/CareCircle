 ...
 */
function StandardizedNavigation({ signOut, user, compact = false }) {
    ...
    >
      ...
      <div className="nav-user">
        ...
        <button
          ...
          title={t('navigation.signOutTitle')}
          aria-label={t('navigation.signOutTitle')}
        >
          <span className="signout-icon">🚪</span>
          {!compact && <span className="signout-text">{t('navigation.signOut')}</span>}
        </button>
      </div>
    </nav>
  );
